...
const getProjectById = async (req, res) => {
    try {
        ...
        if (project) {
            return res.status(200).json({ data: project, message: "Project retrieved successfully!" });
        }
...
const createProject = async (req, res) => {
    try {
        ...
        return res.status(201).json({ data: document, message: 'Project created successfully!' });
    } catch (error) {
        console.error(error);
